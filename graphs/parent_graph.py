...
class TripletGraph:
    def __init__(self, system_prompt, gpt):
        self.triplets = []
    ...
    def generate(self, prompt, max_tokens=None, model='llama', stop_tokens=None, system_prompt="", t=0.9):
        return self.gpt.generate(prompt, max_tokens, model, stop_tokens, self.system_prompt, t)
