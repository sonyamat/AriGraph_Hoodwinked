...
class ContrieverGraph(TripletGraph):
    def __init__(self, system_prompt, device=0, gpt=None):
        super().__init__(system_prompt, gpt)
        ...
        self.new_triplets_cnt = []
        self.replacements_cnt = []
    ...
    def update(self, observation, observations, plan, prev_subgraph, locations, curr_location, previous_location, action, items1, log, topk_episodic):        
        ...
        response = self.generate(prompt, t = 0.001)
        ...
        self.new_triplets_cnt.append(len(new_triplets_str))
        ...
        self.replacements_cnt.append(len(predicted_outdated))
